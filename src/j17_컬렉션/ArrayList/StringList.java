...
public class StringList {
	public static void main(String[] args) {
		...
		//리스트의 크기 (배열과 달리 공간의 크기를 지정하지 않음. 자동으로 늘어남)
		...
		//list.remove(5); //인덱스 번호로 삭제
		System.out.println(list);
		
		//list.removeAll(tempList); //tempList안에 있는거 전부 삭제
		System.out.println(list);
		
		list.retainAll(tempList); //해당 컬렉션을 포함하는 것을 제외하고 다 삭제
		System.out.println(list);
